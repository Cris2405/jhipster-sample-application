...
type EntityResponseType = HttpResponse<IVuelo>;
type EntityArrayResponseType = HttpResponse<IVuelo[]>;
...
export class VueloService {
  ...
  update(vuelo: IVuelo): Observable<EntityResponseType> {
    return this.http.put<IVuelo>(this.resourceUrl, vuelo, { observe: 'response' });
  }
